...
public class Performance {
    ...
    private static final String IP_ADDRESS = getLocalIpAddress();
    private final String serviceCode;
    private final String inputString;

    public Performance(String name, String code, String input) {
        this.name = name;
        this.serviceCode = code; // Gán vào biến instance
        this.inputString = input; // Gán vào biến instance
        total.start();
    }

    public static Performance of (String name, String code, String input)  {
        return new Performance(name,code,input);
    }
    ...
    public void log(String output) {
        synchronized (sb) {
            total.stop();
            log.info("{} {} {} {} {} {}: {}\n{}",
                    "PM", this.serviceCode, this.name, IP_ADDRESS, this.inputString,
                    output, formatDuration(getDuration(total)), sb.toString());
        }
    }
