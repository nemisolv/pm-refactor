...
//
//public class HighPerformanceGenerator2 {
//
//    // ===================================================================================
...
//    private static final int TOTAL_FILES_PER_CYCLE = 5;
//    private static final int SPREAD_DURATION_SECONDS = 60;
//
//    // --- Cấu hình Số bản ghi (Records) ---
//    private static final int RECORDS_PER_FILE_MULTI = 1;
...
//
//    // --- Cấu hình Dọn dẹp ---
//    private static final boolean WIPE_DATA_ON_STARTUP = true; // <--- [NEW] true = Xóa sạch file cũ trước khi chạy
...
//            long millisToSleep = calculateSleepTimeForNextSchedule(1);
...
//            fileName = String.format("%s_%s_%d.capnproto", neName, timestampStr, rand.nextInt(99999));
//            nodeFunction = "1";
//            recordCount = RECORDS_PER_FILE_SINGLE;
//        } else if (luck < (RATE_5G_ONLY + RATE_5G_MIX)) {
//            fileName = String.format("%s_NR_%s_%d.capnproto", neName, timestampStr, rand.nextInt(99999));
//            nodeFunction = rand.nextBoolean() ? "NR_FDD" : "NR_TDD";
//            recordCount = RECORDS_PER_FILE_MULTI;
//        } else {
//            fileName = String.format("%s_LTE_%s_%d.capnproto", neName, timestampStr, rand.nextInt(99999));
